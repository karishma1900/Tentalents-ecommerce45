  ...
  return (
    <div className="products-lists productlistaddtocart">
      ...
      <div className="product-list">
        {products.slice(0,listCount).map((i, index) =>{
     ...
     <p className="discount">{getDiscount(i.price,i.offerPrice)}% OFF</p>
              ...
              <Image src={Array.isArray(i.image) ? i.image[0] : i.image} alt={i.title} className="product-image" fill  />
            </div>
           <div className="content-area2">
              ...
              <button className="background-button">Add to Cart  <PlusIcon /></button>
              </div>
              </div>
              </div>
            </Link>
