...
// Destructure params directly
  ...
  const product = {
    ...
    rating: productRaw.ratings && productRaw.ratings.length > 0
      ? (productRaw.ratings.reduce((sum: number, r: { score: number }) => sum + r.score, 0) / productRaw.ratings.length).toFixed(1)
      : 0,
